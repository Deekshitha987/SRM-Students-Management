    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-6 py-12">
        <div className="flex flex-col items-center justify-center max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            Welcome to the SRM Student Management
          </h1>
          
          <p className="mt-6 text-lg text-muted-foreground">
            Manage your student members efficiently in one place. Add new members, 
      ...
      <footer className="border-t py-6">
        <div className="container mx-auto px-6 text-center text-sm text-muted-foreground">
          SRM Student Management &copy; {new Date().getFullYear()}
        </div>
      </footer>
    </div>
  );
